        ...
        >
            <div x-show="!showRecoveryInput">
                <x-auth-header
                    ...
                    :description="__('Digite o código de autenticação fornecido pelo seu aplicativo autenticador.')"
                />
            </div>
            ...
            <div x-show="showRecoveryInput">
                <x-auth-header
                    ...
                    :description="__('Confirme o acesso à sua conta digitando um dos seus códigos de recuperação de emergência.')"
                />
            </div>
