...
require CLEVERFOX_PLUGIN_DIR . 'inc/colorflow/sections/above-header.php';
...
require CLEVERFOX_PLUGIN_DIR . 'inc/colorflow/features/gradiant-client.php';
...
if ( ! function_exists( 'cleverfox_gradiant_frontpage_sections' ) ) :
	function cleverfox_gradiant_frontpage_sections() {	
		...
		require CLEVERFOX_PLUGIN_DIR . 'inc/colorflow/sections/section-client.php';
    }
