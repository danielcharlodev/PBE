...
require CLEVERFOX_PLUGIN_DIR . 'inc/gradiantx/sections/above-header.php';
...
require CLEVERFOX_PLUGIN_DIR . 'inc/gradiantx/features/gradiant-client.php';
...
if ( ! function_exists( 'cleverfox_gradiant_frontpage_sections' ) ) :
	function cleverfox_gradiant_frontpage_sections() {	
		...
		require CLEVERFOX_PLUGIN_DIR . 'inc/gradiantx/sections/section-client.php';
    }
