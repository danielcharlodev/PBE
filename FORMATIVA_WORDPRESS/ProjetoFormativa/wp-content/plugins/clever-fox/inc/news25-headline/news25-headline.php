...
require CLEVERFOX_PLUGIN_DIR . 'inc/news25-headline/features/news25-news-one.php';
...
if ( ! function_exists( 'cleverfox_news25_frontpage_sections1' ) ) :
	function cleverfox_news25_frontpage_sections1() {		
		require CLEVERFOX_PLUGIN_DIR . 'inc/news25-headline/sections/section-news-one.php';
