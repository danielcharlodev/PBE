<x-app-layout>
                        ...
                        >
                            <div>
                                ...
                                <div style="margin-top:22px; display:flex; justify-content:center; gap:12px; flex-wrap:wrap;">
                                    ...
                                    <button
                                        type="button"
                                        onclick="abrirModalExcluir('{{ $produto->id }}', '{{ addslashes($produto->nome) }}')"
                                        style="
                                            display:inline-block;
    ...
    ">
        ...
        ">
            ...
            <p style="font-size:16px; color:#6b7280; margin-bottom:8px;">
                Você está prestes a excluir este produto:
            </p>

            <p id="nomeProdutoExcluir" style="font-size:20px; font-weight:800; color:#1f2937; margin-bottom:28px;">
                Nome do produto
            </p>
    ...
    <script>
        function abrirModalExcluir(id, nome) {
            ...
            document.getElementById('formExcluirProduto').action = "{{ url('/produtos') }}/" + id;
