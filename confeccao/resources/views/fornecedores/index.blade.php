<x-app-layout>
                        ...
                        >
                            <div>
                                ...
                                <div style="margin-top:22px; display:flex; justify-content:center; gap:12px; flex-wrap:wrap;">
                                    ...
                                    <button
                                        type="button"
                                        onclick="abrirModalExcluir('{{ $fornecedor->id }}', '{{ addslashes($fornecedor->nome) }}')"
                                        style="
                                            display:inline-block;
    ...
    ">
        ...
        ">
            ...
            <p style="font-size:16px; color:#6b7280; margin-bottom:8px;">
                Você está prestes a excluir este fornecedor:
            </p>

            <p id="nomeFornecedorExcluir" style="font-size:20px; font-weight:800; color:#1f2937; margin-bottom:28px;">
                Nome do fornecedor
            </p>
    ...
    <script>
        function abrirModalExcluir(id, nome) {
            document.getElementById('nomeFornecedorExcluir').innerText = nome;
            document.getElementById('formExcluirFornecedor').action = "{{ url('/fornecedores') }}/" + id;
