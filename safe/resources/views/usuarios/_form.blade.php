...
<div class="form-group">
    ...
    <select id="role" name="role" class="form-control" required @disabled($editando)>
        ...
        <option value="portaria" @selected($cargo === 'portaria')>Porteiro</option>
    </select>
    @if ($editando)
...
<div class="form-group">
    ...
    <input id="telefone" type="text" name="telefone" class="form-control" data-mask="telefone"
        value="{{ old('telefone', isset($usuario) ? $usuario->telefone_formatado : '') }}" placeholder="(00) 00000-0000" required>
...
<div id="campos-portaria" class="campos-cargo" style="display:none;">
    ...
    <div class="form-group">
        <label for="setor">Setor / ponto de acesso</label>
        <input id="setor" type="text" name="setor" class="form-control"
            value="{{ old('setor', $usuario->setor ?? '') }}" placeholder="Ex: Entrada principal">
